...
TOTAL_BLINKS =0
location = ""
text1="see the camera"
text2="face not detected"
language1='en'
language2="en"
# constants
CLOSED_EYES_FRAME =3
FONTS =cv.FONT_HERSHEY_COMPLEX
p=gTTS(text=text1, lang=language2, slow=False)
o=gTTS(text=text2, lang=language1, slow=False)
o.save("Noface.mp3")
p.save(r"C:\Users\Rathi\Desktop\Project\warning.mp3")
...
def positionEstimator(cropped_eye):
    ...
    if (location == "CENTER"):
        ...
        playsound(r"C:\Users\Rathi\Desktop\Project\warning.mp3", True)
